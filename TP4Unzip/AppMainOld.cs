...
namespace TP4Unzip
{
  public partial class AppMainOld : Form
  {
    public AppMainOld()
    {
      InitializeComponent();
      ...
      txt_FileNameXsltHtml.Text = Settings.Default.ConnHost;

      txt_XmlStyleSheetElement.Text = Settings.Default.ConnPort;
    ...
    private void OnClosing(object sender, FormClosingEventArgs e)
    {
      ...
      Settings.Default.ConnHost = txt_FileNameXsltHtml.Text.Trim();

      Settings.Default.ConnPort = txt_XmlStyleSheetElement.Text.Trim();
    ...
    private void OnFileNameXsltHtmlBrowseClick(object sender, EventArgs e)
    {
      ...
      if(lResult == DialogResult.OK)
      {
        ...
        Settings.Default.ConnHost = FileNameXsltDialog.FileName;
